...
export default function StatsBar() {
  ...
  return (
    <div className="bg-background border-b border-white/20 px-10 h-[72px] flex items-center">
      <div className="grid grid-cols-6 w-full">
        <div className="flex items-center gap-3 border-r border-white/10 px-6 first:pl-0">
        ...
        {stats.map(({ label, value }) => (
          <div key={label} className="flex flex-col gap-1.5 border-r border-white/10 px-6 last:border-0">
